...
test("Health Rapidfire Prefill Lead Mobile Test", async ({ browser }) => {
  ...
  const response = await page.goto(process.env.ENVIRONMENT_URL || 'https://smartfinancial.com/get-fast-quote-health.html#/quote-ready?session_id=f0c685c6-d77f-444e-a1f6-603145539e67');
...
test('Health Rapidfire Prefill Lead Desktop Test ', async ({ page }) => {
