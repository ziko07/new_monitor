...
test("Life Rapidfire Prefill Lead Mobile Test", async ({ browser }) => {
  ...
  const response = await page.goto(process.env.ENVIRONMENT_URL || 'https://smartfinancial.com/get-fast-quote-life.html#/quote-ready?session_id=533d6710-dbc1-47a1-99f7-55783f99d8f1');
...
test('Life Rapidfire Prefill Lead Desktop Test ', async ({ page }) => {
