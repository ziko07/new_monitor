...
test("Home Rapidfire Prefill Lead Mobile Test", async ({ browser }) => {
  ...
  const response = await page.goto(process.env.ENVIRONMENT_URL || 'https://smartfinancial.com/get-fast-quote-home.html#/quote-ready?session_id=fd247ae2-2b63-4ca5-bc6c-f524ca40c0aa');
...
test('Home Rapidfire Prefill Lead Desktop Test ', async ({ page }) => {
