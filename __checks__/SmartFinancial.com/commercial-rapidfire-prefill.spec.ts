...
test("Commercial Rapidfire Prefill Lead Mobile Test", async ({ browser }) => {
  ...
  const response = await page.goto(process.env.ENVIRONMENT_URL || 'https://smartfinancial.com/get-fast-quote-commercial.html#/quote-ready?session_id=10126926-74ec-4ae2-b84a-f1184ffcfe97');
...
test('Commercial Rapidfire Prefill Lead Desktop Test ', async ({ page }) => {
